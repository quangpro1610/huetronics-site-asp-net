<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ChiTietSP.aspx.cs" Inherits="Default2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table style="width:100%;">
        ...
        <tr>
            <td align="center" colspan="2">
                <a href="<%#Eval("Anh") %>" rel="lightbox[roadtrip]"><asp:Image ID="Image1" 
                    runat="server" Height="150px" Width="200px"/></a>
            </td><br />
        </tr>
        <tr>
