<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="HoaDonChuaGiao.aspx.cs" Inherits="Admin_Default" %>
            ...
            <tr>
                <td style="width: 300px" valign="top">
                    <asp:DataList ID="DataList1" runat="server" DataKeyField="IDHoaDon" 
                        DataSourceID="SqlDataSource1" Width="100%" BorderColor="Silver" 
                                ...
                                <tr>
                                    <td style="width: 100px">
                                        <asp:HyperLink ID="hplIDHoaDon" runat="server" 
                                            NavigateUrl='<%# "HoaDonChuaGiao.aspx?idhd="+Eval("IDHoaDon") %>' 
                                            Text='<%# Eval("IDHoaDon") %>'></asp:HyperLink>
                                    </td>
                                    <td>
                                        <asp:HyperLink ID="hplTinhTrang" runat="server" NavigateUrl='<%# "CapNhatHDChuaGiao.aspx?idhd="+Eval("IDHoaDon") %>' Text='<%# Eval("TinhTrang") %>'></asp:HyperLink>
                                    </td>
                                </tr>
                            </table>
                        </ItemTemplate>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                        ...
                        SelectCommand="HoaDon_ChuaGiao" SelectCommandType="StoredProcedure">
                    </asp:SqlDataSource>
                </td>
