<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="HienThiTheoNSX.aspx.cs" Inherits="Default2" %>
    ...
    <asp:DataList ID="DataList1" runat="server" RepeatColumns="2" GridLines="Both" 
        ...
        <ItemTemplate>
            <table style="width:100%;">
                ...
                <tr>
                    <td colspan="2">
                        <asp:ImageButton ID="btChitiet"  CommandArgument='<%#Eval("IDSanPham") %>' runat="server" ImageUrl="~/Images/chitiet.png" 
                            onclick="bt_ChiTiet_Click" />
                        <asp:ImageButton ID="btThemgio"  CommandArgument='<%#Eval("IDSanPham") %>' runat="server" 
